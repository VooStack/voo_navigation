...
The package includes centralized design tokens for consistent styling:

```dart
import 'package:voo_navigation_core/voo_navigation_core.dart';

// Use static token values
borderRadius: BorderRadius.circular(VooNavigationTokens.itemBorderRadius), // 8dp
size: VooNavigationTokens.iconSizeDefault, // 18dp

// Use theme-aware extension methods
color: context.navSelectedBackground(), // primary @ 10% opacity
hoverColor: context.navHoverBackground, // onSurface @ 4% opacity
background: context.floatingNavBackground, // surfaceContainerHighest
```

Available tokens:
- Icon sizes: `iconSizeDefault` (18), `iconSizeCompact` (20)
- Border radius: `itemBorderRadius` (8), `floatingNavBorderRadius` (28)
- Spacing: `itemPaddingHorizontal`, `itemPaddingVertical`, `iconLabelSpacing`
- Typography: `labelFontSize`, `labelFontWeight`
- Opacity: `opacitySelectedBackground`, `opacityHoverBackground`, `opacityMutedIcon`
