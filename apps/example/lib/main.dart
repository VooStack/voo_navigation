...
class _HRISELinkAppState extends State<HRISELinkApp> {
  ...
  List<VooNavigationDestination> get _navigationItems => [
    ...
    VooNavigationDestination(
      ...
      children: [
        VooNavigationDestination(id: 'employee', label: 'Employee', icon: const Icon(Icons.badge_outlined), mobilePriority: true, route: '/employee'),
        VooNavigationDestination(id: 'attendance', label: 'Attendance', icon: const Icon(Icons.access_time), mobilePriority: true, route: '/attendance'),
        VooNavigationDestination(id: 'checklist', label: 'Checklist', icon: const Icon(Icons.checklist), route: '/checklist'),
        VooNavigationDestination(id: 'time-off', label: 'Time off', icon: const Icon(Icons.event_busy_outlined), route: '/time-off'),
      ],
    ),
    VooNavigationDestination(
      id: 'hire-section',
      ...
      children: [
        VooNavigationDestination(id: 'hiring', label: 'Hiring', icon: const Icon(Icons.person_add_outlined), route: '/hiring'),
        VooNavigationDestination(id: 'onboarding', label: 'Onboarding', icon: const Icon(Icons.flight_takeoff), route: '/onboarding'),
        VooNavigationDestination(id: 'hiring-handbook', label: 'Hiring handbook', icon: const Icon(Icons.menu_book_outlined), route: '/hiring-handbook'),
      ],
    ),
    VooNavigationDestination(
      id: 'finance-section',
      ...
      children: [
        VooNavigationDestination(id: 'payroll', label: 'Payroll', icon: const Icon(Icons.payments_outlined), route: '/payroll'),
        VooNavigationDestination(id: 'expenses', label: 'Expenses', icon: const Icon(Icons.receipt_long_outlined), route: '/expenses'),
        VooNavigationDestination(id: 'incentives', label: 'Incentives', icon: const Icon(Icons.card_giftcard_outlined), route: '/incentives'),
        VooNavigationDestination(id: 'payment-info', label: 'Payment information', icon: const Icon(Icons.credit_card_outlined), route: '/payment-info'),
      ],
    ),
  ];
